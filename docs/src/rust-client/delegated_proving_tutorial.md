...
The code below uses the testnet remote prover to demonstrate delegated proving in action.
...
We construct a `RemoteTransactionProver` pointing at the testnet proving service.
